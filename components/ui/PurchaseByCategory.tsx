                ...
                >
                    <Slider class="carousel carousel-center gap-[14px] col-span-full row-start-2 row-end-5">
                        {cards?.map((card, index) => (
                            <Slider.Item index={index} class="carousel-item w-[296px] h-[581px] flex flex-col items-center justify-center">
                                ...
                                <div class="w-[296px] h-[58px] mb-2">
                                    <p class="text-lg font-medium text-center m-5">{card.description}</p>
                                </div>
                            </Slider.Item>
                        ))}
                    </Slider>
