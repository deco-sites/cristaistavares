export default function AvaliationSection() {
    return (
        <div class="flex w-full h-full items-center justify-center">
            <div class="flex items-center justify-center max-w-[1272px]">
                <section class="flex flex-col items-center justify-center">
                    <div class="flex items-center justify-center">
                        <h1 class="text-center text-[32px] leading-10 font-semibold">Avaliações</h1>
                    </div>
                    <div class="flex flex-col gap-1 align-middle items-start justify-start w-[1272px]">
                            ...
                            <div class="flex flex-col items-start justify-start mt-5">
                                ...
                                <div class="mt-10 pl-2">
                                    <a href="">
                                        <p class="text-sm underline">Faça login para escrever uma avaliação</p>
                                    </a>
                                </div>
                                ...
                                <div class="flex items-start justify-start border-b-4 border-solid border-[#f2f4f5] w-[1272px] mb-5 py-3">
                                    <h1 class="text-start text-xl text-dark-pink font-semibold">Nenhuma avaliação</h1>
                                </div>
                            </div>
                    </div>
                </section>
