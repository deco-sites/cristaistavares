  ...
  if (variant === "slider") {
    return (
      <>
        <div
          id={id}
          class="grid grid-cols-1 gap-4 xl:gap-2 sm:grid-cols-[max-content_30vw_1fr] 2xl:grid-cols-[max-content_30vw_37vw] sm:grid-rows-1 sm:justify-center lg:px-4 2xl:px-0"
        >
          {/* Image Slider */}
